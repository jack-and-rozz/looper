...
phases = ['PreLoop', 'StartLoop', 'StartDay', 'WritersPlot', 'ActorsPlot', 'ActionExecution', 'WritersAbility', 'ActorsAbility', 'Affair', 'EndDay', 'EndLoop', 'FinalGuess']
...
instance_types = ['Location', 'Character', 'Role', 'Action', 'Place', 'Affair', 'RuleY', 'RuleX', 'Player']
instance_types = common.to_ids(instance_types, start=1)

Unknown = common.dotDict({'_id': 0, 'classname': 'Unknown'})

ability_types = ['Mandatory', 'Optional']
ability_types = common.to_ids(ability_types, start=1)
# CharacterInfo = {
